...
TUNING["chemist_yue_ling_er.equip_slot"] = TUNING["chemist_yue_ling_er.equip_slot"] or {}

-------------------------------------------------------------------------------------------------------------------
---- 背包
    TUNING["chemist_yue_ling_er.equip_slot"].GetBackpackType = function(self)
...
-------------------------------------------------------------------------------------------------------------------
---- 项链
    TUNING["chemist_yue_ling_er.equip_slot"].GetAmuletType = function(self)
...
-------------------------------------------------------------------------------------------------------------------
---- armor 盔甲
    TUNING["chemist_yue_ling_er.equip_slot"].GetArmorType = function(self)
