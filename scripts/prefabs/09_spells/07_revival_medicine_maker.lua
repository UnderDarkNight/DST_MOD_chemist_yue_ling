...
local function GetStringsTable(name)
    local prefab_name = name or "chemist_spell_revival_medicine_maker"
...
local function builder_onbuilt(inst, builder)
	...
	if builder and builder:HasTag("chemist_yue_ling") then
        ...
        local item_level = builder.components.chemist_com_skill_point_sys:Add("revival_medicine.item_level",0)
        local double_level = builder.components.chemist_com_skill_point_sys:Add("revival_medicine.double_level",0)
        ...
        if math.random(1000)/1000 <= succeed_rate then
            ---- 制作成功
                ...
                local item = SpawnPrefab("chemist_item_revival_medicine_lv_"..tostring(item_level))
...
return Prefab("chemist_spell_revival_medicine_maker", fn,assets),
            Prefab("chemist_spell_revival_medicine_maker2", fn,assets)