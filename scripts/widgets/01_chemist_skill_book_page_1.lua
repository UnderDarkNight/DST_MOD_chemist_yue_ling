...
return function (book_root,page_num,main_scale_num)
    ...
    ------------------------------------------------------------------------------------------------------------------------
    ---------- 基础数据
        local page_atlas = "images/widget/chemist_skill_book_attack_power_multiplier_medicine.xml"
    ------------------------------------------------------------------------------------------------------------------------
    ---------- 标题
    ...
    ---------- +1 按钮
        ...
        button_lv_up:SetOnClick(function()
            ThePlayer.replica.chemist_com_skill_point_sys:ButtonClick("attack_power_multiplier_medicine.button_lv_up")
        end)
    ------------------------------------------------------------------------------------------------------------------------
    ---------- +MAX 按钮
        ...
        button_lv_max:SetOnClick(function()
            ThePlayer.replica.chemist_com_skill_point_sys:ButtonClick("attack_power_multiplier_medicine.button_lv_max")
        end)
    ------------------------------------------------------------------------------------------------------------------------
    ---------- 双倍框
    ...
    ---------- double +1 按钮
        ...
        button_double_lv_up:SetOnClick(function()
            ThePlayer.replica.chemist_com_skill_point_sys:ButtonClick("attack_power_multiplier_medicine.button_double_lv_up")
        end)
    ------------------------------------------------------------------------------------------------------------------------
    ---------- double +MAX 按钮
        ...
        button_double_lv_max:SetOnClick(function()
            ThePlayer.replica.chemist_com_skill_point_sys:ButtonClick("attack_power_multiplier_medicine.button_double_lv_max")
        end)

    ------------------------------------------------------------------------------------------------------------------------
    ----- 数据初始化
        local data_init_fn = function()
            local item_level = tostring( ThePlayer.replica.chemist_com_skill_point_sys:Get("attack_power_multiplier_medicine.item_level") or 0 )
            local double_level = tostring( ThePlayer.replica.chemist_com_skill_point_sys:Get("attack_power_multiplier_medicine.double_level") or 0 )
